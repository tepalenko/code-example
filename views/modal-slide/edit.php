...
$short_modal_name = (strlen($modal_window->name) > 20) ? substr($modal_window->name, 0, 20) . ' ...' : $modal_window->name;
$this->params['breadcrumbs'][] = ['label' => 'Edit Modal "' . $short_modal_name . '"','url' => ['/modal/edit?id=' . $modal_window->id]];
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <?php $form = ActiveForm::begin(['id' => 'slide-form', 'options' => ['enctype' => 'multipart/form-data']]); ?>
                            ...
                            <?php if (in_array('type', $template_params)):?>
                            ...
                            <?php if (in_array('file', $template_params)):?>
                                ...
                                <div class="form-group">
                                    <img style="width:100px;" class="img-thumbnail" src="/<?=$model->file?>" alt="Photo">  
                                </div>
                                <button id="delete-image" style="width:145px;" onClick="deleteInputFileValue();" type="button" class="btn btn-block btn-danger btn-xs">Delete file</button>
                                <?php endif; ?>
                                <?= $form->field($model, 'file')->hiddenInput()->label(''); ?>
                            <?php endif;?>
                            ...
                            <?php if (empty($model->button_action_next)):?>
                                <?php if (in_array('button_modal_id', $template_params) && in_array($model->type, [ModalSlide::MODAL_SLIDE_REGULAR_TYPE, ModalSlide::MODAL_SLIDE_LAST_TYPE])):?>
                                    <?php
                                ...
                                <?php if (in_array('button_product_tour_id', $template_params) && in_array($model->type, [ModalSlide::MODAL_SLIDE_REGULAR_TYPE, ModalSlide::MODAL_SLIDE_LAST_TYPE])):?>
                                    <?php
                            ...
                            <?php if (in_array('button_action_next', $template_params) && $model->type == ModalSlide::MODAL_SLIDE_REGULAR_TYPE):?>
                                <label class="control-label" for="modalslide-button_action_next">Open next slide on click</label>
                            ...
                            <?= Html::input('hidden', 'base_url', Url::base('http'), ['id' => 'base-url']) ?>
                            <div class="form-group">
